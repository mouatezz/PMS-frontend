            ...
            <div className="flex justify-between">
              <div>
                <div className="flex items-center space-x-2">
                  <h3 className="text-lg font-medium text-gray-900">{reservation.guest}</h3>
                  <span className="text-amber-700 text-sm">RES-{reservation.reservationID}</span>
                </div>
                <div className="mt-1 grid grid-cols-1 md:grid-cols-2 gap-2">
                  <div className="text-sm text-gray-700">
                    <span className="text-gray-900">Room:</span> {reservation.room} 
                  </div>
                  <div className="text-sm text-gray-700">
                  ...
                  <div className="text-sm text-gray-700">
                    <span className="text-gray-900">Payment:</span> ${reservation.total_price}
                    {reservation.payments?.length > 0 ? (
                      <span className="ml-2 text-emerald-600  items-center inline-flex">
                        <CheckCircle size={12} className="mr-1" />Paid
                      </span>
                    ) : (
                      <span className="ml-2 text-amber-600  items-center inline-flex">
