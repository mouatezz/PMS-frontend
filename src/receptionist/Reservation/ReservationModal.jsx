      ...
      <div className="bg-white rounded-lg shadow-lg p-6 max-w-3xl w-full max-h-screen overflow-y-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <label className="block text-gray-700 mb-1">Check-in Date & Time</label>
              <input
                type="datetime-local"
                name="check_in"
            ...
            <div>
              <label className="block text-gray-700 mb-1">Check-out Date & Time</label>
              <input
                type="datetime-local"
                name="check_out"
            ...
            <div>
              ...
              <input
                ...
                readOnly
                className="w-full px-3 py-2 border border-gray-300 bg-gray-50 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="is_checked_in" className="text-gray-700">Checked In</label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <label htmlFor="is_checked_out" className="text-gray-700">Checked Out</label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <label htmlFor="is_cancelled" className="text-gray-700">Cancelled</label>
              </div>
            </div>
          </div>
          
          <div className="mb-6">
            <h3 className="text-lg font-medium text-gray-800 mb-2">Companions</h3>
            <div className="bg-gray-50 border border-gray-200 p-4 rounded-md">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 font-medium rounded-md transition duration-200"
              >
                Add Companion
              </button>
              ...
              {formData.companions.length > 0 && (
                <div className="mt-4">
                  <h4 className="text-gray-700 mb-2">Added Companions</h4>
                  <div className="space-y-2">
                    {formData.companions.map((companion, index) => (
                      <div key={index} className="flex justify-between items-center p-2 bg-white border border-gray-200 rounded-md">
                        <div>
                          <span className="text-gray-800 font-medium">{companion.fullname}</span>
                          <span className="text-gray-500 ml-2">ID: {companion.NationalID}</span>
                          <span className="text-gray-500 ml-2">{companion.phone}</span>
                        </div>
                        <button
                          type="button"
