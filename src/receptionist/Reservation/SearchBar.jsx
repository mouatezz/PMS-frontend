...
const SearchBar = ({ searchTerm, setSearchTerm, statusFilter, setStatusFilter, handleAddReservation }) => {
  return (
    <div className="mb-6">
      <h2 className="text-xl font-semibold text-white mb-4">Manage Reservations</h2>
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex space-x-3">
          <div className="relative">
            ...
            <select
              className="pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-400"
              value={statusFilter}
          ...
          <button 
            className="bg-amber-400 hover:bg-amber-500 text-gray-900 py-2 px-4 rounded-lg flex items-center space-x-2 transition-colors"
