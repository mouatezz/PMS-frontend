        ...
        <main className="p-6">
          {!showGuestForm ? (
            <div className="bg-gray-800 rounded-lg shadow-lg p-6">
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-white mb-4">Today's Expected Check-ins</h2>
              ...
              <div className="mt-8">
                <h2 className="text-xl font-semibold text-white mb-4">Walk-in Check-in</h2>
                <div className="bg-gray-700/50 rounded-lg p-6 text-center">
                  <p className="text-white mb-4">Need to check in a guest without a reservation?</p>
                  <button 
                    className="bg-amber-400/20 hover:bg-amber-400/30 text-amber-300 py-3 px-6 rounded-lg flex items-center space-x-2 mx-auto transition-colors"
            ...
            <div className="bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-400"
                  ...
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-2">
                        <label className="block text-sm text-gray-400">Companion Details</label>
                      ...
                      <div className="bg-gray-700 border border-gray-600 rounded-lg p-3">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          <input
                            ...
                            className="px-3 py-2 bg-gray-600 border border-gray-500 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-400"
                          />
                          <input
                            type="text"
                ...
                <div className="md:col-span-1">
                  ...
                  <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
                    <h3 className="font-medium text-white mb-3 flex items-center">
                      <Key className="h-5 w-5 mr-2 text-amber-300" />
                      Room Access
                    </h3>
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="keycardIssued" className="ml-2 text-sm text-white">
                          Keycard Issued
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input 
                          ...
                          className="w-4 h-4 text-amber-400 bg-gray-700 border-gray-600 rounded focus:ring-amber-400"
                        />
                        <label htmlFor="doNotDisturb" className="ml-2 text-sm text-white">
                          Do Not Disturb
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <input 
                          ...
                          className="w-4 h-4 text-amber-400 bg-gray-700 border-gray-600 rounded focus:ring-amber-400"
                        />
                        <label htmlFor="idVerified" className="ml-2 text-sm text-white">
                          ID Verified
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input 
                          ...
                          className="w-4 h-4 text-amber-400 bg-gray-700 border-gray-600 rounded focus:ring-amber-400"
                        />
                        <label htmlFor="paymentCollected" className="ml-2 text-sm text-white">
                          Payment Collected
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input 
                          ...
                          className="w-4 h-4 text-amber-400 bg-gray-700 border-gray-600 rounded focus:ring-amber-400"
                        />
                        <label htmlFor="is_checked_in" className="ml-2 text-sm text-white">
