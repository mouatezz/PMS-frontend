      ...
      <div className="flex-1 md:ml-64">
        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                <a href="/check-in" className="block bg-amber-50 hover:bg-amber-100 transition-colors text-amber-700 p-4 rounded-lg">
                  <div className="flex items-center">
                    <ClipboardCheck className="h-6 w-6 mr-3" />
                    <span className="font-medium">Process Check-in</span>
                  </div>
                </a>
                <a href="/check-out" className="block bg-amber-50 hover:bg-amber-100 transition-colors text-amber-700 p-4 rounded-lg">
                  <div className="flex items-center">
                    <Users className="h-6 w-6 mr-3" />
                    <span className="font-medium">Process Check-out</span>
                  </div>
                </a>
                <a href="/reservations" className="block bg-amber-50 hover:bg-amber-100 transition-colors text-amber-700 p-4 rounded-lg">
                  <div className="flex items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Upcoming Check-ins */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Today's Check-ins</h2>
                ...
                <div key={index} className="flex flex-col mb-4 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                  <div>
                    ...
                    <div className="flex items-center space-x-4 mt-1">
                      ...
                      <span className="text-xs text-gray-500">ID: {checkin.id}</span>
                    </div>
                  </div>
                </div>
              ))}
            ...
            {/* Upcoming Check-outs */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Today's Check-outs</h2>
                ...
                <div key={index} className="flex flex-col mb-4 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                  <div>
                    ...
                    <div className="flex items-center space-x-4 mt-1">
                      ...
                      <span className="text-xs text-gray-500">ID: {checkout.id}</span>
                    </div>
                  </div>
                </div>
              ))}
